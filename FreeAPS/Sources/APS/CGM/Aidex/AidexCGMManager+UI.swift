    ...
    public var body: some View {
        Form {
            ...
            Section {
                ...
                Text("""
                По умолчанию сенсор сам передаёт текущее значение каждые 5 минут. \
                При включении этого режима iAPS раз в минуту опрашивает историю \
                сенсора и получает ежеминутные значения глюкозы.
                """)
            }
